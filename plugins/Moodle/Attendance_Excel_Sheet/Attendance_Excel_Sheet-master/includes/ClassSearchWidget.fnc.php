...
function _classSearchWidgetFindCourse( $extra )
{
	...
	echo '<form action="' . ( function_exists( 'URLEscape' ) ?
		URLEscape( 'Modules.php?modname=' . $_REQUEST['modname'] .
			...
			issetVal( $_REQUEST['next_modname'], '' ) ) :
	...
	{
		echo '<option value="' . ( function_exists( 'AttrEscape' ) ? AttrEscape( $teacher['STAFF_ID'] ) : htmlspecialchars( $teacher['STAFF_ID'], ENT_QUOTES ) ) . '">' . $teacher['FULL_NAME'] . '</option>';
	}
	...
	{
		echo '<option value="' . ( function_exists( 'AttrEscape' ) ? AttrEscape( $subject['SUBJECT_ID'] ) : htmlspecialchars( $subject['SUBJECT_ID'], ENT_QUOTES ) ) . '">' . $subject['TITLE'] . '</option>';
	}
	...
	{
		echo '<option value="' . ( function_exists( 'AttrEscape' ) ? AttrEscape( $period['PERIOD_ID'] ) : htmlspecialchars( $period['PERIOD_ID'], ENT_QUOTES ) ) . '">' . $period['TITLE'] . '</option>';
	}
